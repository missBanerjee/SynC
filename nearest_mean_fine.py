...
if __name__ == "__main__":
    ...
    for run in range(0, 1):
        ...
        print("introducing nearest mean classifiers as classifiers and as a view ,text as a view after 10 epochs, mean-k*std,k=3")
        args.data_root= inaturalist_root
        args.num_labeled_classes = 28
        args.num_unlabeled_classes = 56
        
        #print("food_root",food_root)
        ...
        # TRAIN  , , 
        # ----------------------
        train(projection_head, model, train_loader = labelled_train_loader, test_loader= test_loader, unlabelled_train_loader = unlabelled_train_loader,args= args)
