...
def train(projection_head, model,textEmbed, train_loader, test_loader, unlabelled_train_loader, args):
...
if __name__ == "__main__":
    ...
    for run in range(0, 1):
        ...
        print("introducing nearest mean classifiers as classifiers and as a view after 10 epochs, mean-k*std,k=4")
        ...
        # TRAIN
        # ----------------------
        train(projection_head, model,textEmbed, labelled_train_loader, test_loader, unlabelled_train_loader, args)
